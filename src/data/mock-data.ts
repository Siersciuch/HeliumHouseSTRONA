...
export const mockPeople: Person[] = [
  { id: "p1", firstName: "Paweł", lastName: "Wołowicz", name: "Paweł Wołowicz", email: "pawel.wolowiczuth@gmail.com", phone: "512 853 951", city: "Otwock", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev1", "ev3"] },
  { id: "p2", firstName: "Michał", lastName: "Surma", name: "Michał Surma", email: "michal.surma@gmail.com", phone: "735 270 635", city: "Otwock", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev2", "ev5"] },
  { id: "p3", firstName: "Piotr", lastName: "Szlasa", name: "Piotr Szlasa", email: "piotr_szlasa@interia.eu", phone: "503 634 739", city: "Otwock", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev1", "ev4"] },
  { id: "p4", firstName: "Robert", lastName: "Zganiacz", name: "Robert Zganiacz", email: "robert.zganiacz@icloud.com", phone: "607 657 336", city: "", drivingLicense: "B,C", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev2", "ev6", "ev7"] },
  { id: "p5", firstName: "Siersciuch", lastName: "", name: "Siersciuch", email: "rastabiba@gmail.com", phone: "733 304 709", city: "Warszawa", drivingLicense: "", isAdmin: true, hasKeys: true, electricalCert: false, heightCert: false, trips: [] },
  { id: "p6", firstName: "Daniel", lastName: "Obsowski", name: "Daniel Obsowski", email: "d.obsowski@telemagic.com.pl", phone: "735 270 635", city: "Żyrardów", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev3", "ev5"] },
  { id: "p7", firstName: "Piotr", lastName: "Kępiński", name: "Piotr Kępiński", email: "p.ludwik@outlook.com", phone: "793 376 670", city: "Żyrardów", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev4"] },
  { id: "p8", firstName: "Marceli", lastName: "Paziewski", name: "Marceli Paziewski", email: "marceln958@wp.pl", phone: "506 593 884", city: "Otwock", drivingLicense: "", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev6"] },
  { id: "p9", firstName: "Michał", lastName: "Pietrzak", name: "Michał Pietrzak", email: "extransport@vp.pl", phone: "722 024 677", city: "", drivingLicense: "", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev7"] },
  { id: "p10", firstName: "Paweł", lastName: "Stawiński", name: "Paweł Stawiński", email: "office@heliumhouse.eu", phone: "", city: "", drivingLicense: "", isAdmin: true, hasKeys: true, electricalCert: false, heightCert: false, trips: [] },
  { id: "p11", firstName: "Adrian", lastName: "Błażejewski", name: "Adrian Błażejewski", email: "ddrummer420@gmail.com", phone: "733 500 489", city: "Warszawa", drivingLicense: "", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev1", "ev5"] },
  { id: "p12", firstName: "David", lastName: "Yaremchuk", name: "David Yaremchuk", email: "dawidjaremczuk1@gmail.com", phone: "884 006 914", city: "Warszawa", drivingLicense: "", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev2"] },
  { id: "p13", firstName: "Artur", lastName: "Boroń", name: "Artur Boroń", email: "arturboron06@gmail.com", phone: "881 229 433", city: "Wołomin", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev3", "ev7"] },
  { id: "p14", firstName: "Tymon", lastName: "Celmer", name: "Tymon Celmer", email: "tymoteusz.celmer@gmail.com", phone: "518 255 045", city: "Warszawa", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev4", "ev6"] },
  { id: "p15", firstName: "Nazarii", lastName: "Yaremchuk", name: "Nazarii Yaremchuk", email: "nazarjaremczuk87@gmail.com", phone: "453 670 194", city: "Warszawa", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: [] },
  { id: "p16", firstName: "Piotr", lastName: "Kozyrski", name: "Piotr Kozyrski", email: "p.kozyrski@heliumhouse.eu", phone: "733 304 709", city: "Warszawa", drivingLicense: "", isAdmin: true, hasKeys: true, electricalCert: false, heightCert: false, trips: [] },
  { id: "p17", firstName: "Ryszard", lastName: "Kot", name: "Ryszard Kot", email: "r.kot@heliumhouse.eu", phone: "500 444 283", city: "Warszawa", drivingLicense: "B", isAdmin: true, hasKeys: true, electricalCert: false, heightCert: false, trips: [] },
  { id: "p18", firstName: "Kuba", lastName: "Wnęk", name: "Kuba Wnęk", email: "kw_72@wp.pl", phone: "501 193 606", city: "Warszawa", drivingLicense: "B", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev5", "ev7"] },
  { id: "p19", firstName: "Przemek", lastName: "Kępiński", name: "Przemek Kępiński", email: "", phone: "732 925 753", city: "Żyrardów", drivingLicense: "B,C,E", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: ["ev6"] },
  { id: "p20", firstName: "Mariusz", lastName: "Perszon", name: "Mariusz Perszon", email: "mapers@op.pl", phone: "604 323 321", city: "Otwock", drivingLicense: "", isAdmin: false, hasKeys: false, electricalCert: false, heightCert: false, trips: [] },
];
